...
public class SpadeWorldListener extends WorldListener {
    ...
    public void loadWorlds() {
        ...
        if (worlds != null) {
            for (String worldName : worlds) {
                ...
                spade.loadWorld(worldName, cfg.getInt("worlds." + worldName + ".seed", (int) (new Random()).nextLong()), cfg.getString("worlds." + worldName + ".chunk-manager.name", "stock"), cfg.getString("worlds." + worldName + ".chunk-provider.name", "stock"), cfg.getNode("worlds." + worldName + ".chunk-provider.config"));
            }
        } else {
    ...
    public void saveWorlds() {
        ...
        for (World w : spade.getServer().getWorlds()) {
            cfg.setProperty("worlds." + w.getName() + ".chunk-provider", Configuration.getEmptyNode().getAll());
