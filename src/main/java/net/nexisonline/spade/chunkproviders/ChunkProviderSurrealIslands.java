		...
		for (int x = 0; x < 16; x++)
		{
			for (int y = 0; y < 128; y += 16)
			{
				for (int z = 0; z < 16; z++)
				{
					...
					frequency = 0.05;
					amplitude = 5;
					double warp = m_simplexGenerator1.sample(posX, posY, posZ, frequency, amplitude);

					frequency = 0.005;
					amplitude = 10;
					warp += m_simplexGenerator2.sample(posX, posY, posZ, frequency, amplitude);

					frequency = 0.0005;
					amplitude = 15;
					warp += m_simplexGenerator3.sample(posX, posY, posZ, frequency, amplitude);

					frequency = 0.00005;
					amplitude = 20;
					warp += m_simplexGenerator4.sample(posX, posY, posZ, frequency, amplitude);
