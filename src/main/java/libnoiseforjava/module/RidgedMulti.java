...
public class RidgedMulti extends ModuleBase {
    ...
    public double getValue(double x, double y, double z) {
        ...
        for (int curOctave = 0; curOctave < octaveCount; curOctave++) {
            ...
            final int curSeed = (seed + curOctave) & 0x7fffffff;
    ...
    public void setOctaveCount(final int octaveCount) throws ExceptionInvalidParam {
    ...
    public void setSpectralWeights(final double[] spectralWeights) {
