...
public class Terrace extends ModuleBase {
    ...
    public Terrace(final ModuleBase sourceModule) throws ExceptionInvalidParam {
        super(1);
    ...
    public void addControlPoint(final double value) throws ExceptionInvalidParam {
        // Find the insertion point for the new control point and insert the new
        // point at that position. The control point array will remain sorted by
        // value.
        final int insertionPos = findInsertionPos(value);
    ...
    // / control point array.
    public int findInsertionPos(final double value) throws ExceptionInvalidParam {
        int insertionPos;
    ...
    public double getValue(final double x, final double y, final double z) {
        ...
        final int index0 = Misc.ClampValue(indexPos - 1, 0, controlPointCount - 1);
        final int index1 = Misc.ClampValue(indexPos, 0, controlPointCount - 1);
    ...
    public void insertAtPos(final int insertionPos, final double value) {
        ...
        // that array.
        final double[] newControlPoints = new double[controlPointCount + 1];
    ...
    // / start of this curve has a slope of zero; its slope then smoothly
    // / increases. At the control points, its slope resets to zero.
    void makeControlPoints(final int controlPointCount) throws ExceptionInvalidParam {
    ...
    // / control points.
    public void invertTerraces(final boolean invert) {
        if (invert) {
