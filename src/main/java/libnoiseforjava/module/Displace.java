...
public class Displace extends ModuleBase {
    ...
    public Displace(final ModuleBase sourceModuleOne, final ModuleBase sourceModuleTwo, final ModuleBase sourceModuleThree, final ModuleBase sourceModuleFour) throws ExceptionInvalidParam {
        super(4);
    ...
    public double getValue(final double x, final double y, final double z) {
        ...
        final double xDisplace = x + (sourceModules[1].getValue(x, y, z));
        final double yDisplace = y + (sourceModules[2].getValue(x, y, z));
        final double zDisplace = z + (sourceModules[3].getValue(x, y, z));
    ...
    public void setDisplaceModules(final ModuleBase xDisplaceModule, final ModuleBase yDisplaceModule, final ModuleBase zDisplaceModule) {
    ...
    public void setXDisplaceModule(final ModuleBase xDisplaceModule) {
    ...
    // / This displacement module must exist throughout the lifetime of this
    // / noise module unless another displacement module replaces it.
    public void setYDisplaceModule(final ModuleBase yDisplaceModule) {
        assert (sourceModules != null);
    ...
    // / This displacement module must exist throughout the lifetime of this
    // / noise module unless another displacement module replaces it.
    public void setZDisplaceModule(final ModuleBase zDisplaceModule) {
        assert (sourceModules != null);
