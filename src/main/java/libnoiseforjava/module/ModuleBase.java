...
public class ModuleBase {
    ...
    public ModuleBase(final int modulesRequired) {
    ...
    // / method.
    public ModuleBase getSourceModule(final int index) throws ExceptionNoModule {
        if (sourceModules != null) {
            if ((index >= getSourceModuleCount()) || (index < 0) || (sourceModules[index] == null))
    ...
    // / its output values.
    public void setSourceModule(final int index, final ModuleBase sourceModule) throws ExceptionInvalidParam {
        if (sourceModules != null) {
