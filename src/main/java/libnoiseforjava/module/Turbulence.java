...
public class Turbulence extends ModuleBase {
    ...
    public Turbulence(final ModuleBase sourceModule) throws ExceptionInvalidParam {
        super(1);
    ...
    public double getValue(final double x, final double y, final double z) {
        ...
        final double xDistort = x + (xDistortModule.getValue(x0, y0, z0) * power);
        final double yDistort = y + (yDistortModule.getValue(x1, y1, z1) * power);
        final double zDistort = z + (zDistortModule.getValue(x2, y2, z2) * power);
    ...
    // / modules.
    public void setRoughness(final int roughness) throws ExceptionInvalidParam {
