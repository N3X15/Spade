...
public class Line {
    ...
    public double getValue(final double p) {
        ...
        final double x = ((x1 - x0) * p) + x0;
        final double y = ((y1 - y0) * p) + y0;
        final double z = ((z1 - z0) * p) + z0;
        final double value = module.getValue(x, y, z);
    ...
    public void setModule(final ModuleBase module) {
        this.module = module;
    }
    ...
    public void setZ0(final double z0) {
        this.z0 = z0;
    }
