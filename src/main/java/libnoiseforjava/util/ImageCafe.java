...
public class ImageCafe {
    ...
    public ImageCafe(final int width, final int height) throws ExceptionInvalidParam {
    ...
    public ColorCafe getValue(final int x, final int y) {
    ...
    public void setSize(final int width, final int height) throws ExceptionInvalidParam {
        if ((width < 0) || (height < 0))
    ...
    public void setValue(final int x, final int y, final ColorCafe value) {
        if ((x >= 0) && (x < width) && (y >= 0) && (y < height)) {
            imageCafeColors[x][y] = value;
        }
    }
    ...
    // / All positions outside of the image are assumed to have a common
    // / color value known as the <i>border value</i>.
    public void setBorderValue(final ColorCafe borderValue) {
