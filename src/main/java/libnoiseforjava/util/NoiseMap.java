...
public class NoiseMap {
    ...
    public NoiseMap(final int width, final int height) throws ExceptionInvalidParam {
    ...
    public double getValue(final int x, final int y) {
        if ((x >= 0) && (x < width) && (y >= 0) && (y < height))
            return noiseMap[x][y];
        // The coordinates specified are outside the noise map. Return the
        // border
        // value.
        else
            return borderValue;
    ...
    // / All positions outside of the noise map are assumed to have a
    // / common value known as the <i>border value</i>.
    public void setBorderValue(final double borderValue) {
