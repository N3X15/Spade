...
public class GradientColor {
    ...
    public void addGradientPoint(final double gradientPos, final ColorCafe gradientColor) throws ExceptionInvalidParam {
        ...
        final int insertionPos = findInsertionPos(gradientPos);
    ...
    public int findInsertionPos(final double gradientPos) throws ExceptionInvalidParam {
        int insertionPos;
    ...
    public ColorCafe getColor(final double gradientPos) {
        ...
        final int index0 = Misc.ClampValue(indexPos - 1, 0, gradientPointCount - 1);
        final int index1 = Misc.ClampValue(indexPos, 0, gradientPointCount - 1);
        ...
        // get
        // the corresponding gradient color of the nearest gradient point and
        // exit
        // now.
        if (index0 == index1) {
        ...
        final double input0 = gradientPoints[index0].position;
        final double input1 = gradientPoints[index1].position;
        final double alpha = (gradientPos - input0) / (input1 - input0);
        
        // Now perform the linear interpolation given the alpha value.
        final ColorCafe color0 = gradientPoints[index0].color;
        final ColorCafe color1 = gradientPoints[index1].color;
    ...
    public void insertAtPos(final int insertionPos, final double gradientPos, final ColorCafe gradientColor) {
