...
public class NoiseMapBuilder {
    ...
    public NoiseMapBuilder(final int height, final int width) throws ExceptionInvalidParam {
        callback = 0;
        destHeight = 0;
        destWidth = 0;
    ...
    public void setDestNoiseMap(final NoiseMap destNoiseMap) {
    ...
    public void setSourceModule(final ModuleBase sourceModule) {
    ...
    public void setDestSize(final int destWidth, final int destHeight) {
    ...
    void setCallback(final int callback) {
