...
public class NoiseGen {
    ...
    public enum NoiseQuality {
        ...
        // / Generates coherent noise quickly. When a coherent-noise function
        // with
        // / this quality setting is used to generate a bump-map image, there
        // are
        ...
        // / function with this quality setting is used to generate a bump-map
        // / image, there are no "creasing" artifacts in the resulting image.
        // This
    ...
    public static double GradientCoherentNoise3D(final double x, final double y, final double z, final int seed, final NoiseQuality noiseQuality) {
    ...
    public static double GradientNoise3D(final double fx, final double fy, final double fz, final int ix, final int iy, final int iz, final int seed) {
        ...
        final VectorTable vectorTable = new VectorTable();
    ...
    public static double ValueCoherentNoise3D(final double x, final double y, final double z, final int seed, final NoiseQuality noiseQuality) {
        // Create a unit-length cube aligned along an integer boundary. This
        // cube
        // surrounds the input point.
        final int x0 = (x > 0.0 ? (int) x : (int) x - 1);
